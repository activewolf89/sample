  ...
  <StyledDiv borderTop='2px solid gray' display='flex'  textAlign='center' alignItems='center' >
    {
      props.textUs ?
        ...
        <Div display='flex' flexDirection='column' alignItems='center'   cursor='pointer' onClick={()=>{props.onContactClick(props.direct)}}>
    ...
    <Div padding='5px'>
      ...
      </P>
      {
        props.textUs ?
          ...
          <Button add padding='10px 0'  width='350px' onClick={()=>{props.onContactClick(props.direct)}}>
            <StyledLink to={props.link}>
              <Div color='white'>
                {props.name}
              </Div>
