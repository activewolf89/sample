  ...
  return (
    <StyledDiv  >
      <StyledLink to={props.buttonObj.url}>
        <StyledHiddenDiv  opacity='.9'  border='2px solid white' width='100%' height='100%' position='absolute' textAlign='center' borderRadius='3%' >
        ...
        <Div position='absolute' color='white' textAlign='center' width='100%'>
          ...
          <Div textAlign='center' >
            <Button    width='100vw' maxWidth='300px' backgroundColor='#353535' color='white'>
