      ...
      <Div position="relative">
        ...
        unmountOnExit>
          <OutsideAlerter callback = {()=>{this.handleToggle('alert')}}>
            <StyledDiv themed border="1px solid gray" color="black"  zIndex="100" width="100%"  opacity="100%" backgroundColor="white">
              <Ol childrenPadding="5px" childrenBorderBottom="1px solid gray"  maxHeight="300px" overflow="auto">
