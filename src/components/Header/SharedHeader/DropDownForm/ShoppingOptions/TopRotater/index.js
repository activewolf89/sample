...
const funcC0mp = (props) =>{
  ...
  return (
    <Div  textAlign='center' backgroundColor='lightGray' color='black'>
      ...
      <Tabs onSelect={()=>{}} selectedIndex={FindWhichIndexIsSelected(pathname,[["engagement-rings","loose-diamonds"],["wedding-bands"],["fine-jewelry"]])}>
        ...
        <TabList >
          ...
          {
            pathname.includes('wedding-band') &&
            <Tab
          ...
          {
            pathname.includes('fine-jewelry') &&
            <Tab
        ...
        <TabPanel>
          <Tabs onSelect={()=>{}} selectedIndex={FindWhichIndexIsSelected(pathname,[["engagement-rings"],["loose-diamonds"]])}>
            <TabList>
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/bridal/loose-diamonds',props.history,'/shop')}}
        ...
        <TabPanel>
          <Tabs onSelect={()=>{}}   selectedIndex={FindWhichIndexIsSelected(pathname,[["mens-bands"],["ladies-bands"]])}>
            <TabList>
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/wedding-bands/mens-bands',props.history,'/shop/wedding-bands')}}
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/wedding-bands/ladies-bands',props.history,'/shop/wedding-bands')}}
        ...
        <TabPanel>
          <Tabs onSelect={()=>{}} selectedIndex={FindWhichIndexIsSelected(pathname,[["necklace"],["earring"],["fine-ring"],["bracelet"],["watch"],["other"]])}>
            <TabList>
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/fine-jewelry/necklace',props.history,'/shop/fine-jewelry')}}
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/fine-jewelry/earring',props.history,'/shop/fine-jewelry')}}
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/fine-jewelry/fine-ring',props.history,'/shop/fine-jewelry')}}
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/fine-jewelry/bracelet',props.history,'/shop/fine-jewelry')}}
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/fine-jewelry/watch',props.history,'/shop/fine-jewelry')}}
              ...
              <Tab
                onClick={()=>{SendCustomerThroughARide('/shop/fine-jewelry/other',props.history,'/shop/fine-jewelry')}}
